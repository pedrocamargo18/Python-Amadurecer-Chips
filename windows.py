...
def janela_config():
    ...
    return sg.Window('PoupaZap - 1.0.1', layout3, icon='icone.ico', size=(800, 400), finalize=True)
...
def custom_program():
    ...
    return sg.Window('PoupaZap - 1.0.1', layoutC, icon='icone.ico', size=(600,200), finalize=True)